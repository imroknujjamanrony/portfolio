...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    // Force re-layout on mount to fix initial width issues
    ...
    >
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown lg:hidden">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-black/90 backdrop-blur-md rounded-box w-52 max-w-xs text-white"
          >
            {links.map((link, index) => (
              <li key={index}>
                {link.section ? (
